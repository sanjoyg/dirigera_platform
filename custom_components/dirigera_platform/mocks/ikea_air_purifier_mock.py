...
class ikea_starkvind_air_purifier_mock_device:
    ...
    def __init__(self) -> None:
        ikea_starkvind_air_purifier_mock_device.counter = ikea_starkvind_air_purifier_mock_device.counter + 1
        self._name = "MOCK Air Purifier " + str(ikea_starkvind_air_purifier_mock_device.counter)
        self._unique_id = "AP1907151129080101_" + str(ikea_starkvind_air_purifier_mock_device.counter)
    ...
    def update(self):
        if self._updated_at is None or \
            (datetime.datetime.now() - self._updated_at).total_seconds() > 10:
            try:
    ...
    @property
    def unique_id(self):
        logger.info("Returning unique_id as {} airpurifier mock...".format(self._unique_id))
    ...
    def turn_on(self, percentage = None, preset_mode = None, **kwargs) -> None:
        ...
        if preset_mode is not None:
            ...
            logger.debug("We were asked to be turned on but percentage and preset were not set, using last know")
